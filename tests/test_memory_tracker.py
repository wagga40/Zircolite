...
class TestMemoryTrackerSample:
    ...
    def test_no_rate_limit_by_default(self, test_logger):
        """With default interval=0, every sample() call should record."""
        mock_proc = MagicMock()
...
class TestMemoryTrackerIntegration:
    ...
    def test_full_tracking_workflow(self, test_logger):
        ...
        assert peak_formatted == "120.00 MB"
